...
export const BASEURL = wx.getAccountInfoSync().miniProgram.envVersion === 'release' ? 'https://rss.vieewer.com/api/v2/' : 'https://rss2.vieewer.com/api/v2/'

export const IMAGEBASEURL = wx.getAccountInfoSync().miniProgram.envVersion === 'release' ? 'https://rss.vieewer.com/media/cache/resolve/' : 'https://rss2.vieewer.com/media/cache/resolve/' 
