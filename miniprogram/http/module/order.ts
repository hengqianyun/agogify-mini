...
const orderModule = {
  ...
  getPaymentState: async (tokenValue: string) => await get<swaggerI.orderPaymentStateResult, swaggerI.pageRequestParams>('store/orders/' + tokenValue + '/payments', {page: 1, itemsPerPage: 1}),
