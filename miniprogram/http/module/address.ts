...
const addressModule = {
  ...
  queryAddressList: async (params: swaggerI.queryAddressListParams) => await get<swaggerI.addressListResult, swaggerI.queryAddressListParams>('store/addresses', params),
